...
def get_filters():
    ...
    while city not in CITY_DATA:
        city = input('error.Please Try Again!')
        city = city.casefold()
    ...
    while day not in days:
        day=input('wrong input, try again')
        day= day.casefold()
...
def station_stats(df):
    ...
    startendcomb=df.groupby(['Start Station', 'End Station']).size().head(1)

    print("The most frequent combination of start station and end station trip",startendcomb)
